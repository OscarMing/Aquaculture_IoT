...
class MQTT_NAS:
    ...
    def MQTT_Data_Analyze(self,dataIn):    # dictionary data in
        ...
        # Feed servo to control  1 -> 3 , 0 --> RESET
        ...
        elif 'Motor1' in dataIn.keys():
            return 'R5,%s\n\r' % str(dataIn['Motor1']), 1    
        elif 'Relay6' in dataIn.keys():
            return 'R6,%s\n\r' % str(dataIn['Relay6']), 1
        elif 'Motor2' in dataIn.keys():
            return 'R6,%s\n\r' % str(dataIn['Motor2']), 1
        ...
        elif 'Servo_down' in dataIn.keys():  # water in : 1
...
# Sensor_Test  Motor1, Motor2: 1 , 0   # relay5, relay6
