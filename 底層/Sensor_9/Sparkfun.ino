...
void tsl_setup() {
  if (tsl.begin()) {
    ...
    lcd.clear();
    lcd.setCursor(0,0); lcd.print("tsl...Error");
    delay(10000);
  }
...
void Get_tsl() {
  ...
  full = lum & 0xFFFF;
  Get_TSL.var1_IR = ir;
  Get_TSL.var2_FULL = full;
  Get_TSL.var3_VISIBLE = full - ir;
  Get_TSL.var4_LUX = tsl.calculateLux(full, ir);
  ...
  Serial.print("Lux: "); Serial.println( Get_TSL.var4_LUX);
  */
}
